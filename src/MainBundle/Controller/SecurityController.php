...
use MainBundle\Form\Security\RegistrationType;
use MainBundle\Form\Security\ForgotPasswordType;
use MainBundle\C;
...
class SecurityController extends GeneralController
{
    ...
    public function registrationAction(Request $request)
    {
        ...
        return $this->render('MainBundle:Security:registration.html.twig', [
    ...
    public function forgotPasswordAction(Request $request)
    {
        ...
        return $this->render('MainBundle:Security:forgotPassword.html.twig', [
            'form' => $form->createView(),
        ]);
    }
}
